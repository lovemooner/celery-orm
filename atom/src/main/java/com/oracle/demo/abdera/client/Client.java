...
import com.oracle.demo.abdera.collectionAdapter.Employee;
...
public class Client {
    ...
    public static void testPost(String url, Employee employee) {
        Abdera abdera = Abdera.getInstance();
        AbderaClient client = new AbderaClient(abdera);
    ...
    public static void testDelete(String url, String id) {
        Abdera abdera = Abdera.getInstance();
        AbderaClient client = new AbderaClient(abdera);
        RequestOptions opts = new RequestOptions();
